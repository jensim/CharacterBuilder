...
@NamedQueries({
    @NamedQuery(name = "TrudvangPower.findAll", query = "SELECT t FROM TrudvangPower t")})
public class TrudvangPower implements Serializable {
    ...
    public TrudvangPower(Integer id, String name, String description, int pointCost, String duration, String reach) {
        this.id = id;
        this.name = name;
    ...
    public String toString() {
        return "se.jensim.chargen.persistence.entities.TrudvangPower[ id=" + id + " ]";
    }
