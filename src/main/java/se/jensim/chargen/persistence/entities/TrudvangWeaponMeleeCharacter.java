...
@NamedQueries({
    @NamedQuery(name = "TrudvangWeaponMeleeCharacter.findAll", query = "SELECT t FROM TrudvangWeaponMeleeCharacter t")})
public class TrudvangWeaponMeleeCharacter implements Serializable {
    ...
    public TrudvangWeaponMeleeCharacter(Integer id) {
        this.id = id;
    }

    public TrudvangWeaponMeleeCharacter(Integer id, String name, String description, int sh, int im, int bv, int ps, int weight, int damageStatic, int price) {
        this.id = id;
        this.name = name;
    ...
    public String toString() {
        return "se.jensim.chargen.persistence.entities.TrudvangWeaponMeleeCharacter[ id=" + id + " ]";
    }
