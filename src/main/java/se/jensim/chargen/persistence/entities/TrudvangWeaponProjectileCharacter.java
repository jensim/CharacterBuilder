...
@NamedQueries({
    @NamedQuery(name = "TrudvangWeaponProjectileCharacter.findAll", query = "SELECT t FROM TrudvangWeaponProjectileCharacter t")})
public class TrudvangWeaponProjectileCharacter implements Serializable {
    ...
    public TrudvangWeaponProjectileCharacter(Integer id) {
        this.id = id;
    }

    public TrudvangWeaponProjectileCharacter(Integer id, String name, String description, int sh, int im, int bv, int pvShort, int pvLong, int weight, int damageStatic, int distanceShort, int distanceLong, int price) {
        this.id = id;
        this.name = name;
    ...
    public String toString() {
        return "se.jensim.chargen.persistence.entities.TrudvangWeaponProjectileCharacter[ id=" + id + " ]";
    }
