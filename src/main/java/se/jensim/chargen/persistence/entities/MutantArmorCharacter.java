 ...
 */
@Entity
@Table(name = "mutant_armor_character", catalog = "rollspel", schema = "public")
@NamedQueries({
    @NamedQuery(name = "MutantArmorCharacter.findAll", query = "SELECT m FROM MutantArmorCharacter m")})
public class MutantArmorCharacter implements Serializable {
    ...
    public MutantArmorCharacter(Integer id) {
        this.id = id;
    }

    public MutantArmorCharacter(Integer id, String name, int abs, int beg, int weight, int price, String description) {
        this.id = id;
        this.name = name;
        this.abs = abs;
        this.beg = beg;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MutantArmorCharacter)) {
            return false;
        }
        MutantArmorCharacter other = (MutantArmorCharacter) object;
    ...
    public String toString() {
        return "se.jensim.chargen.persistence.entities.MutantArmorCharacter[ id=" + id + " ]";
    }
